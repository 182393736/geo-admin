...
const { buildBrandTokens, pruneOverbroadBrandTokens, findBrandToken, findBrandTokenInCandidate, filterBrandMentions, filterBrandMentionStrings } = require('./neutral');
...
module.exports = {
  ...
  buildBrandTokens, pruneOverbroadBrandTokens, findBrandToken, findBrandTokenInCandidate, filterBrandMentions, filterBrandMentionStrings,
  NEUTRAL_RULES,
