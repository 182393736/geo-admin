    ...
    <div class="space-y-2">
      <div class="flex flex-wrap items-center gap-2">
        ...
        <span class="text-xs text-muted-foreground">
          剩余修改 <span data-testid="rename-remaining" class="font-semibold text-foreground">{{ renameRemaining }}</span> 次
        </span>
        <Button
          type="button"
          variant="outline"
      ...
      <Input :model-value="name" readonly data-testid="brand-name-ro" class="bg-muted/40" />
    </div>
