...
export const GEO_LEARN_PAGES: HubLearnPage[] = [
    ...
    sections: [
      {
        heading: 'GEO 是什么？',
        paragraphs: [
          'GEO（Generative Engine Optimization，生成式引擎优化）是通过改进内容结构、可访问性与权威信号，提高品牌或页面在生成式 AI 答案中被提及、正确描述或引用为信源的概率的实践。',
          '学术上，该术语由 Aggarwal 等人在 KDD 2024 论文中系统提出；商业实践范围更宽。Google 搜索中心亦指出：针对生成式 AI 搜索体验的优化，从搜索角度看仍属于 SEO。',
        ],
      },
      {
        heading: 'GEO 和 SEO 有什么区别？',
        paragraphs: [
          'SEO 优化搜索结果页（蓝链）排名与点击；GEO 优化生成式答案中的品牌占位、表述与信源。成功单位不同：一次点击 vs 一次提及/引用（常为零点击）。',
          '二者共用可抓取、E-E-A-T 与清晰结构等基础。应共用品牌实体与事实底座，分流 KPI，而不是二选一。',
        ],
      },
      {
        heading: 'GEO 不是什么',
        paragraphs: [
          '不是训练语料操控，也不是提示词工程。不是「发得越多越好」或无法复核的排行榜营销。',
          '有效做法是：固定问题集建基线 → 按引用缺口补可抽取证据 → 同口径复测，用证据包而非截图汇报。',
        ],
      },
      {
        heading: '如何开始做 GEO？',
        paragraphs: [
          '锁定 10–20 条高意图题（选型/对比/替代），分引擎看未出现率；补一类证据后双周复测。',
          '需要工具时再使用诊断或监测；先方法，再产品。',
        ],
      },
    ],
    faq: [
      {
        q: 'GEO 会取代 SEO 吗？',
        a: '不会。Google 也将面向生成式 AI 功能的优化视为搜索优化的一部分。应并行经营。',
      },
      {
        q: 'GEO 是不是只是营销新词？',
      ...
      {
        q: '中小团队也需要 GEO 吗？',
        a: '若目标客户已在用 AI 做品类与方案对比，就需要。可从核心高意图题集与基线起步。',
      },
    ],
  },
  {
    ...
    description: '系统说明 GEO 应同时观察的指标，以及如何放在一张表里做决策。',
    ...
    sections: [
      {
        heading: 'GEO 核心指标有哪些？',
        paragraphs: [
          '至少同时看：品牌提及率、平均推荐位、品牌描述倾向、问题覆盖率、竞品差距、有效引用源数量与类型。',
        ],
      },
      {
        heading: '为什么不能只看提及率？',
  ...
  },
  {
    ...
    description: '不同生成式引擎的采样与引用习惯不同，GEO 监测需要分引擎看，不能只看综合分。',
    ...
    sections: [
      {
        heading: '为什么要分引擎监测？',
        paragraphs: [
          '同一问题在不同引擎的提及率与引用源结构可以差很多。综合分会掩盖「某一引擎完全未出现」的风险。',
        ],
      },
      {
        heading: '如何选监测引擎集合？',
        paragraphs: [
          '优先覆盖目标用户真实使用的引擎，再保留 1–2 个对照引擎。名单确定后不要频繁改动。',
        ],
      },
    ],
    faq: [
      {
        q: '海外引擎要监测吗？',
        a: '若客户决策发生在海外或双语场景，应纳入；否则先做国内主力引擎。',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    description: '说明蓝链与 AI 答案如何共用事实底座，以及分工与排期方式。',
    keywords: 'GEO和SEO并行,内容体系,生成式引擎优化',
    relatedProduct: '/compare/geo-vs-seo',
    sections: [
      {
        heading: '为什么要并行而不是二选一？',
        paragraphs: [
          '用户仍会从搜索进入官网，也会直接向 AI 提问选型。共用品牌实体与可抽取事实，再分别优化蓝链与答案占位，成本最低。',
        ],
      },
      {
        heading: '排期建议',
        paragraphs: [
          'SEO 负责主题集群与外链；GEO 负责高意图问题集、引用源与复测。共享 brief 中的事实字段。',
        ],
      },
    ],
    faq: [
      {
        q: '预算有限先投哪里？',
        a: '先用免费诊断看 AI 答案缺口；若搜索仍是主流量，保留基础 SEO，把增量预算给高意图 GEO 题。',
      },
    ],
  },
  {
