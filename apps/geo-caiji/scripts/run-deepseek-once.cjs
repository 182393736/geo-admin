 ...
 * node apps/geo-caiji/scripts/run-deepseek-once.cjs [prompt]
 */
...
const SRC = path.join(os.homedir(), 'Library/Application Support/geo-caiji/profiles', IP);
const DIR = path.join(os.tmpdir(), 'geo-caiji-deepseek-once');
const PROFILE = path.join(DIR, 'profile');
const OUT = path.join(os.homedir(), 'Library/Application Support/geo-caiji/results', IP);
